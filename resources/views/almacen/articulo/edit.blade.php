    ...
    <div class="row">
        ...
        <div class="col-lg col-sm-6 col-xs-12">
            <div class="form-group">
                ...
                <input type="text" name="stock" disabled="disabled" required value="{{$articulo->stock}}" class="form-control">
            </div>
        </div>
        ...
        <div class="col-lg col-sm-6 col-xs-12">
            <div class="form-group">
                ...
                <input type="number" name="precio_venta" value="{{$articulo->precio_venta}}" class="form-control" placeholder="precio venta...">
            </div>
        </div>
